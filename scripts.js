     ...
     try {
         const response = await fetch('https://api.openai.com/v1/chat/completions', {
             ...
             headers: {
                 ...
                 'Authorization': 'Bearer sk-2b4esjvI6hvI1rN7ZTe5UlKqc_X3ppYJGUv5RQZkXGT3BlbkFJ5hfMxWmXrCxQe3gDfodXfl_o-OM7ZoKVgvF8EoJ5oA' // Remplace par ta clé API
             },
             body: JSON.stringify({
                 model: "gpt-3.5-turbo",
                 messages: messages
         ...
         chatBody.scrollTop = chatBody.scrollHeight; // Scroll jusqu'en bas
 
         // Affichage de la bulle Joris avec l'introduction
         chatBody.innerHTML += `<p class="bulle-joris"></p>`;
         
         // Animation de l'affichage mot par mot dans la bulle
         typeWriterEffect(chatBody.lastChild, messageBot);
         conversationHistory.push({ role: "assistant", content: messageBot }); // Ajouter la réponse à l'historique
     } catch (error) {
